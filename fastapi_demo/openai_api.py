...
async def predict(
    ...
    def mock_response_generator():
        mock_responses = ["Mock response 1", "Mock response 2", "Mock response 3"]
...
def _get_args():
    ...
    parser.add_argument('--api-auth', help='API authentication credentials', type=str)
